...
class Death(Scene):
    ...
    quips = [
        ...
        "Yoir Mom would be proud...if she were smarter.",
        "Such a luser.", 
...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""
             ...
             blow the ship yp after getting into an escape pod.

             You're running down the central corrdior to the Weapons
             Armory when a Gothon jumpy out, red scaly skin, dark grimy
